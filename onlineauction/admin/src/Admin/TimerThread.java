	...
	public void run() {
		...
		try 
		{
			...
			while(i.hasNext())
			{
				item=i.next();
				Barray=item.b;
				File file=new File("C:/Users/mc358/Downloads/Online-Auction-System-master/Online-Auction-System-master/Admin2/AdminImages/"+String.valueOf(item.ID)+".txt");
				fos=new FileOutputStream(file);
				fos.write(Barray);
				image=new ImageIcon("C:/Users/mc358/Downloads/Online-Auction-System-master/Online-Auction-System-master/Admin2/AdminImages/"+String.valueOf(item.ID)+".txt");
