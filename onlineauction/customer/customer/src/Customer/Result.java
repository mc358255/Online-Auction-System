...
public class Result extends JPanel {
	...
	public void refresh() throws Exception
	{
		...
		while(i.hasNext())
		{
			item=i.next();
			Barray=item.b;
			File file=new File("C:/Users/mc358/Downloads/Online-Auction-System-master/Online-Auction-System-master/Customer/CustomerImages/"+String.valueOf(item.ID)+".txt");
			fos=new FileOutputStream(file);
			fos.write(Barray);
			image=new ImageIcon("C:/Users/mc358/Downloads/Online-Auction-System-master/Online-Auction-System-master/Customer/CustomerImages/"+String.valueOf(item.ID)+".txt");
