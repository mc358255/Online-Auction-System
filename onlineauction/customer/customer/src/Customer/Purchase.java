	...
	public void refresh() throws Exception
	{
		...
		if(status && !flag)
		{
			...
			while(it.hasNext())
			{
				sentitem=it.next();
				Barray=sentitem.b;
				File file=new File("C:/Users/mc358/Downloads/Online-Auction-System-master/Online-Auction-System-master/Customer/CustomerImages/"+String.valueOf(sentitem.ID)+".txt");
				fos=new FileOutputStream(file);
				fos.write(Barray);
				image=new ImageIcon("C:/Users/mc358/Downloads/Online-Auction-System-master/Online-Auction-System-master/Customer/CustomerImages/"+String.valueOf(sentitem.ID)+".txt");
